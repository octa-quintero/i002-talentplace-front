...
export const Postulaciones = () => {
    ...
    const {application, loading} = useFetchApplicationsById();
    console.log(application);



    //! HAY QUE HACER UN FETCH
    //! LUEGO UN HOOK CON ESE FETCH
    //! Y MAPEARLO EN ESTE COMPONENTE
    //TODO este componente muestra los proyectos a los cuales el usuario se postula
